                    ...
                    <div class="container">
                        <div class="jumbotron-content">
                            <div class="jumbotron-content__description">
                                <div class="p1">
                                    <span class="s1"><?echo $arItem["PREVIEW_TEXT"];?></span>
                                </div>
                                <div>

                                    <a target="_self" href="<?echo $arItem["DISPLAY_PROPERTIES"]["LINK"]["VALUE"];?>" class="btn btn-primary"><?echo $arItem["DISPLAY_PROPERTIES"]["LINK_TEXT"]["VALUE"];?></a>
                                </div>
